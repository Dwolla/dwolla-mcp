...
import {
  ...
  UpdateMassPaymentRequest$zodSchema,
  UpdateMassPaymentResponse,
  UpdateMassPaymentResponse$zodSchema,
} from "../models/operations/updatemasspayment.js";
 ...
 */
export function massPayments_update(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateMassPaymentRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/mass-payments/{id}")(
    pathParams$,
  );
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, UpdateMassPaymentResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
      key: "MassPayment",
    }),
    M.json(400, UpdateMassPaymentResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
      key: "BadRequestError",
    }),
    M.json(403, UpdateMassPaymentResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
      key: "403_application/vnd.dwolla.v1.hal+json_object",
    }),
    M.json(404, UpdateMassPaymentResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
