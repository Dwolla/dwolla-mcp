...
import {
  ...
  ListCustomerFundingSourcesRequest$zodSchema,
  ListCustomerFundingSourcesResponse,
  ListCustomerFundingSourcesResponse$zodSchema,
} from "../models/operations/listcustomerfundingsources.js";
 ...
 * List customer funding sources
 */
export function customers_fundingSources_list(
  client$: DwollaMcpCore,
  request: ListCustomerFundingSourcesRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListCustomerFundingSourcesRequest$zodSchema.parse(value$),
