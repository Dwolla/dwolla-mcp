...
} from "../models/operations/createcustomer.js";
 ...
 */
export function customers_create(
...
> {
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.nil(201, CreateCustomerResponse$zodSchema, { hdrs: true }),
    M.json(400, CreateCustomerResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
      key: "BadRequestError",
    }),
    M.json(403, CreateCustomerResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
      key: "403_application/vnd.dwolla.v1.hal+json_object",
    }),
    M.json(404, CreateCustomerResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
