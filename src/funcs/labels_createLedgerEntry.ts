...
import {
  ...
  CreateLabelLedgerEntryRequest$zodSchema,
  CreateLabelLedgerEntryResponse,
  CreateLabelLedgerEntryResponse$zodSchema,
} from "../models/operations/createlabelledgerentry.js";
 ...
 */
export function labels_createLedgerEntry(
  client$: DwollaMcpCore,
  request: CreateLabelLedgerEntryRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateLabelLedgerEntryRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.nil(201, CreateLabelLedgerEntryResponse$zodSchema, { hdrs: true }),
    M.json(400, CreateLabelLedgerEntryResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
      key: "BadRequestError",
    }),
    M.json(403, CreateLabelLedgerEntryResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
      key: "ForbiddenError",
    }),
    M.json(404, CreateLabelLedgerEntryResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
      key: "NotFoundError",
    }),
