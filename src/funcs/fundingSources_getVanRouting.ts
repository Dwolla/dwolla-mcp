...
import {
  ...
  GetVanRoutingRequest$zodSchema,
  GetVanRoutingResponse,
  GetVanRoutingResponse$zodSchema,
} from "../models/operations/getvanrouting.js";
 ...
 */
export function fundingSources_getVanRouting(
  client$: DwollaMcpCore,
  request: GetVanRoutingRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetVanRoutingRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/funding-sources/{id}/ach-routing")(
    pathParams$,
  );
