...
import {
  UpdateRequest,
  UpdateRequest$zodSchema,
  UpdateResponse,
  UpdateResponse$zodSchema,
} from "../models/operations/update.js";
 ...
 */
export function customers_update(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, UpdateResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
      key: "Customer",
    }),
    M.json(400, UpdateResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
      key: "400_application/vnd.dwolla.v1.hal+json_object",
    }),
    M.json(403, UpdateResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
