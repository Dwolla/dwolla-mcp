...
} from "../models/operations/getcustomer.js";
...
> {
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetCustomerResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
      key: "Customer",
    }),
    M.json(403, GetCustomerResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
      key: "403_application/vnd.dwolla.v1.hal+json_object",
    }),
    M.json(404, GetCustomerResponse$zodSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
