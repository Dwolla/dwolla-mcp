...
import { customers_exchanges_create } from "../../funcs/customers_exchanges_create.js";
import { CreateCustomerExchangeRequest$zodSchema } from "../../models/operations/createcustomerexchange.js";
import { formatResult, ToolDefinition } from "../tools.js";

const args = {
  request: CreateCustomerExchangeRequest$zodSchema,
};

export const tool$customers_exchanges_create: ToolDefinition<typeof args> = {
...
`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await customers_exchanges_create(
      client,
      args.request,
