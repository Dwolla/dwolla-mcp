...
import { customers_listAvailableConnections } from "../../funcs/customers_listAvailableConnections.js";
import { ListAvailableExchangeConnectionsRequest$zodSchema } from "../../models/operations/listavailableexchangeconnections.js";
...
export const tool$customers_listAvailableConnections: ToolDefinition<
  typeof args
> = {
...
`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await customers_listAvailableConnections(
      client,
      args.request,
