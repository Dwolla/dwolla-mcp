...
import { clientTokens_create } from "../../funcs/clientTokens_create.js";
import { CreateClientTokenRequest$zodSchema } from "../../models/operations/createclienttoken.js";
import { formatResult, ToolDefinition } from "../tools.js";

const args = {
  request: CreateClientTokenRequest$zodSchema,
};

export const tool$clientTokens_create: ToolDefinition<typeof args> = {
...
`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await clientTokens_create(
      client,
      args.request,
