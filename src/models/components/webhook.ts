...
export const Request$zodSchema: z.ZodType<Request, z.ZodTypeDef, unknown> = z
  .object({
...
export const Response$zodSchema: z.ZodType<Response, z.ZodTypeDef, unknown> = z
  .object({
    body: z.string().optional(),
...
export const Attempt$zodSchema: z.ZodType<Attempt, z.ZodTypeDef, unknown> = z
  .object({
    ...
    request: z.lazy(() => Request$zodSchema).optional(),
    response: z.lazy(() => Response$zodSchema).optional(),
  });
